...
function AlbumOptions({albumdata, saved, only_tracks, setModal, modal}) {
   ...
   function handlereview() {
    ...
    return (
         <div className="mt-6 flex space-x-3">
              ...
              { savestate ? ( 
                  <button className="flex items-center justify-center p-2 bg-indigo-200 hover:bg-indigo-200 text-indigo-700 rounded-md transition cursor-pointer"
                  onClick={deletesave}>
                    ...
                    <button className="flex items-center justify-center p-2 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded-md transition cursor-pointer"
                      onClick={handlesave}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" >
                      <path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"/>
                    </svg>
